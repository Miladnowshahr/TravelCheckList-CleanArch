...
namespace SophieTravelManagement.Domain.Entities
{
    public class TravelerCheckList:AggregateRoot<TravelerCheckListId>
    {
        ...
        public TravelerCheckList(Guid id, TravelerCheckListName name, Destination destination)
        {
            Id = id;
            _name = name;
        ...
        public TravelerCheckList(Guid id, TravelerCheckListName name, Destination destination, LinkedList<TravelerItem> items) : this(id, name, destination)
        {
            _items = items;
        }
